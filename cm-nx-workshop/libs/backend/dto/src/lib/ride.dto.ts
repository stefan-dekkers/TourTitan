...
import { IsNotEmpty, IsBoolean, IsEnum, IsDate, ValidateNested, IsOptional, IsObject } from 'class-validator';
import { Type } from 'class-transformer';
import { ICar, ICreateRide, IUpdateRide, Status } from '@cm-nx-workshop/shared/api';
